...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* Main Content Section (Relocated from Hero) */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-2 md:row-span-2 bg-white p-8 rounded-lg shadow-sm text-center hover-scale">
              ...
              <p className="text-gray-600">
                We follow strict quality control processes to ensure your spices are always at their peak of freshness and flavor,
            ...
            <Card className="p-6 text-center flex flex-col items-center hover-scale">
              ...
              <p className="text-sm text-gray-600">All products are certified authentic and tested for quality</p>
            </Card>
            
            <Card className="p-6 text-center flex flex-col items-center hover-scale">
              <Award className="h-10 w-10 text-cardamom mb-4" />
              <h3 className="font-semibold mb-2">Award Winning</h3>
              <p className="text-sm text-gray-600">Multiple awards for our quality and sustainable practices</p>
            </Card>
            
            <Card className="p-6 text-center flex flex-col items-center hover-scale">
              <Users className="h-10 w-10 text-turmeric mb-4" />
              <h3 className="font-semibold mb-2">10,000+ Customers</h3>
              <p className="text-sm text-gray-600">Trusted by thousands of happy customers worldwide</p>
            </Card>
            
            <Card className="p-6 text-center flex flex-col items-center hover-scale">
              <ThumbsUp className="h-10 w-10 text-cinnamon mb-4" />
              <h3 className="font-semibold mb-2">4.9/5 Rating</h3>
              <p className="text-sm text-gray-600">Excellent ratings across all review platforms</p>
            </Card>
          </div>
        </div>
      </section>
