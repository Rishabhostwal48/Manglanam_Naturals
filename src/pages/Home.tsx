...
export default function Home() {
  ...
  const homeSchema = {
    ...
    "logo": "https://manglanam.com/images/manglanam.png",
    "description": "Discover premium quality spices and herbs at Manglanam Naturals. Experience the authentic flavors of nature.",
    "address": {
      "@type": "PostalAddress",
      "addressCountry": "IN"
    },
    "sameAs": [
      "https://facebook.com/manglanam",
      "https://instagram.com/manglanam",
      "https://twitter.com/manglanam"
    ]
  };
  ...
  return (
    <>
      <SEO 
        title="Premium Spice Emporium"
        description="Discover premium quality spices and herbs at Manglanam Naturals. Experience the authentic flavors of nature with our carefully sourced, pure, and natural spices."
        schema={homeSchema}
      />
