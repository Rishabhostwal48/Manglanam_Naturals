...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [featured, bestselling, allProducts] = await Promise.all([
              ...
              <CardContent>
                          ...
                          <TableRow key={index}>
                            <TableCell>
                              <div className="flex items-center gap-3">
                                <div className="w-9 h-9 rounded-md bg-gray-200 animate-pulse hidden sm:block"></div>
                                <div className="flex flex-col gap-1">
                                  <div className="h-4 w-32 bg-gray-200 animate-pulse rounded"></div>
                                  <div className="h-3 w-16 bg-gray-200 animate-pulse rounded hidden sm:block"></div>
                                </div>
                              </div>
                            </TableCell>
                              ...
                              <div className="flex items-center gap-3">
                                ...
                                <div className="flex flex-col">
                                  ...
                                  <span className="text-xs text-muted-foreground hidden sm:inline">
                                    #{(product._id || product.id || '').toString().slice(0, 8)}
                                  </span>
                                </div>
                              </div>
                            </TableCell>
                ...
                <div className="space-y-3 md:hidden">
                  {loading ? (
                    Array(5).fill(0).map((_, index) => (
                      <div key={index} className="flex items-center justify-between border-b pb-3">
                        ...
                        <div className="text-right">
                          <div className="h-4 w-16 bg-gray-200 animate-pulse rounded ml-auto mb-1"></div>
                          <div className="h-5 w-20 bg-gray-200 animate-pulse rounded ml-auto"></div>
                        </div>
                      </div>
                    ))
                    ...
                    bestSellers.slice(0, 5).map((product) => (
                      <div key={product._id || product.id} className="flex items-center justify-between border-b pb-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <span className="text-xs text-muted-foreground">
                              #{(product._id || product.id || '').toString().slice(0, 6)}
                            </span>
                          </div>
                        </div>
                        <div className="text-right">
